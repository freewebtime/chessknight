...
namespace Incorporations.Assets.GameCode.Shared.Other
{
    public static class RectTransformTools
    {

        [MenuItem("GameObject/Adjust Anchors to Position %l")]
        static void Adjust()
        {
        ...
        [MenuItem("GameObject/Adjust Position To Anchors %k")]
        static void AdjustToAnchors()
        {
            foreach (GameObject gameObject in Selection.gameObjects)
            {
                adjustPostToAnchors(gameObject);
            }
        }

        static void adjustPostToAnchors(GameObject gameObject)
        {
